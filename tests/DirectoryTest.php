...
class DirectoryTest extends PHPUnit_Framework_TestCase {
    ...
    public function test_directory() {
        $dir1 = self::getDir() . '/dir_1/dir1';
        $dir1_file = $dir1 . '/foo.txt';
        $dir1_file_content = 'foo bar';
        $dir2 = self::getDir() . '/dir_2/dir2';
        $dir2_file = $dir2 . '/foo.txt';
        $dir3 = self::getDir() . '/dir_3/dir3';
        $dir3_file = $dir3 . '/foo.txt';
        $dir4 = self::getDir() . '/dir_3/dir-3';
        $dir4_name = 'dir-3';
        $dir4_file = $dir4 . '/foo.txt';
        ...
        $this->assertEquals(['foo.txt'], directory_list($dir1));
